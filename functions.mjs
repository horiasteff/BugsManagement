...
//   if (request.params.echipaId) {
//     console.log(request.params.echipaId);
//     return request.params.echipaId;
//   } else {
//     return undefined;
//   }
// }
...
async function getRecordJoinModel(Model, Model2, request, response) {
  try {
    let record = await Model2.findByPk(request.params.id, {
      attributes: attributes(request),
    });
    if (record) {
